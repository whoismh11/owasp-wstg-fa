...
> این تنها ترجمه رسمی OWASP-WSTG به زبان فارسی میباشد که در [پروژه منبع](https://github.com/OWASP/wstg#translations) نیز لیست شده است.
...
#### 4.1.5 [Review Web Page Content for Information Leakage (بررسی محتوای صفحه وب برای نشت اطلاعات)](4-Web_Application_Security_Testing/01-Information_Gathering/05-Review_Web_Page_Content_for_Information_Leakage.md)
