...
• نرخ بروز (Incidence Rate): نرخ بروز درصدی از برنامه های کاربردی آسیب پذیر در برابر آن CWE از جمعیت آزمایش شده توسط آن سازمان برای آن سال است.

• (آزمایش) پوشش ((Testing) Coverage): درصدی از برنامه های کاربردی که توسط همه سازمان ها برای یک CWE آزمایش شده است.
