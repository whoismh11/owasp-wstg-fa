...
- به عنوان [متعادل کننده بار](#متعادل-کننده-بار-load-balancer) یا [فایروال برنامه وب](#فایروال-برنامه-وب-web-application-firewall-waf) عمل می کند.
...
اگر یک WAF مبتنی بر ابر استفاده می‌شود، ممکن است با استفاده از روش‌های مشابهی که در بخش [شبکه تحویل محتوا](#شبکه-تحویل-توزیع-محتوا-cdn-content-delivery-network-cdn) بحث شده است، با دسترسی مستقیم به سرور پشتیبان، آن را دور بزنید.
