...
<div dir="rtl"></div>`security.txt` یک استاندارد پیشنهادی ([proposed standard](https://securitytxt.org/)) است که به وب سایت ها اجازه می دهد تا سیاست های امنیتی و جزئیات تماس را تعریف کنند. دلایل متعددی وجود دارد که ممکن است در سناریوهای آزمایشی جالب باشد، از جمله اما نه محدود به:
