...
این دستورالعمل `Disallow` مشخص می کند که کدام منابع توسط عنکبوت ها / روبات ها / خزنده ها ممنوع است. در مثال بالا موارد زیر ممنوع است:
...
عنکبوت ها/ربات ها/خزنده های وب می توانند عمدا دستورالعمل های `Disallow` مشخص شده در یک فایل `robots.txt`، مانند دستورالعمل های شبکه های اجتماعی را نادیده بگیرند ([intentionally ignore](https://blog.isc2.org/isc2_blog/2008/07/the-attack-of-t.html)) تا اطمینان حاصل کنند که پیوندهای مشترک هنوز معتبر هستند. از این رو، `robots.txt` نباید به عنوان مکانیزمی برای اعمال محدودیت در نحوه دسترسی، ذخیره یا انتشار مجدد محتوای وب توسط اشخاص ثالث در نظر گرفته شود.
