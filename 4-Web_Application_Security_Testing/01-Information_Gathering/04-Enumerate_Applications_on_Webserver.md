...
**3- هاست های مجازی (Virtual Hosts)**

ا DNS اجازه می دهد تا یک آدرس IP واحد با یک یا چند نام نمادین مرتبط شود. برای مثال، آدرس IP 192.168.1.100ممکن است با نام های DNS مرتبط باشد www.example.com، . لزومی ندارد که همه نام ها متعلق به یک دامنه DNS باشند. این رابطه 1 به N ممکن است برای ارائه محتوای مختلف با استفاده از به اصطلاح میزبان های مجازی منعکس شود. اطلاعاتی که میزبان مجازی مورد نظر ما را مشخص می کند در سربرگ میزبان HTTP 1.1 تعبیه شده است .helpdesk.example.comwebmail.example.com
