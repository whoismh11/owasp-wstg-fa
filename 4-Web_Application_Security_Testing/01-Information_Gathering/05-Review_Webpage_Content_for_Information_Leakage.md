...
اگرچه به طور کلی انتظار نمی رود که پاسخ های تغییر مسیر حاوی محتوای وب قابل توجهی باشند، هیچ اطمینانی وجود ندارد که آنها نمی توانند حاوی محتوا باشند. بنابراین، در حالی که پاسخ های سری 300 (redirect) اغلب حاوی https://example.com/محتوای نوع "redirecting to" هستند، ممکن است محتوا نیز به بیرون درز کند.
...
RingZer0 Online CTF - Challenge 104 "Admin Panel".
